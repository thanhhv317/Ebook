              ...
              <div class="box">
                <div class="box-header">
                  ...
                  <div class="btn-toolbar pull-right">
                    ...
                    <div class="btn-group">
                        <a class="btn btn-circle btn-bordered btn-fill show-tooltip" title="Print" href="{!! route('admin.publisher.getPrint') !!}" target="_blank"><i class="fa fa-print"></i></a>
                        <a class="btn btn-circle btn-bordered btn-fill show-tooltip" title="Export to PDF" href="{!! route('admin.publisher.getPdf') !!}" target="_blank"><i class="fa fa-file-text-o"></i></a>
                        <a class="btn btn-circle btn-bordered btn-fill show-tooltip" title="Export to Exel" href="{!! route('admin.publisher.getExcel') !!}" target="_blank"><i class="fa fa-table"></i></a>
                    </div>
                    <div class="btn-group">
