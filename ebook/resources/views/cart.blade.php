...
@section('content')
	...
	<section class="cart bgwhite p-t-70 p-b-100">
		<div class="container">
			...
			<!-- Total -->
			<div class="bo9 w-size18 p-l-40 p-r-40 p-t-30 p-b-38 m-t-30 m-r-0 m-l-auto p-lr-15-sm notificate2" >
				...
				<div class="size15 trans-0-4 ">
					<!-- Button -->
					<a><button class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4 {{ (auth::user()) ? "checkout-hasLogin" : "checkout-nonLogin"}}">
...
<!--===============================================================================================-->
	...
	<script>
		$('.checkout-nonLogin').click(function(event) {
        
	        swal({
	              title: "Bạn chưa đăng nhập",
	              text: "Bạn có muốn đăng nhập vào hệ thống?",
	              icon: "success",
	              buttons: true,
	              dangerMode: true,
	        })
	        .then((willDelete) => {
	            if (willDelete) {
	                ...
	                swal("đang chuyển hướng đăng nhập", {
	                icon: "success",
	                });  
	            } else {
	                swal("đang chuyển hướng thanh toán");
	                window.location.href = "{{  url('checkout') }}";
	            }
	        });
	        
	    });
	    $('.checkout-hasLogin').click(function(event) {
				window.location.href = "{{  url('checkout') }}";
	    });
	</script>
	<script>
