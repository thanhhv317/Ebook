...
<!--===============================================================================================-->
	<link rel="icon" type="image/png" href="{!! url('public/page/images/icons/favicon.png') !!}"/>
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="{!! url('public/page/vendor/bootstrap/css/bootstrap.min.css') !!}">
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="{!! url('public/page/fonts/font-awesome-4.7.0/css/font-awesome.min.css') !!}">
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="{!! url('public/page/fonts/themify/themify-icons.css') !!}">
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="{!! url('public/page/fonts/Linearicons-Free-v1.0.0/icon-font.min.css') !!}">
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="{!! url('public/page/fonts/elegant-font/html-css/style.css') !!}">
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="{!! url('public/page/vendor/animate/animate.css') !!}">
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="{!! url('public/page/vendor/css-hamburgers/hamburgers.min.css') !!}">
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="{!! url('public/page/vendor/animsition/css/animsition.min.css') !!}">
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="{!! url('public/page/vendor/select2/select2.min.css') !!}">
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="{!! url('public/page/vendor/daterangepicker/daterangepicker.css') !!}">
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="{!! url('public/page/vendor/slick/slick.css') !!}">
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="{!! url('public/page/vendor/lightbox2/css/lightbox.min.css') !!}">
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="{!! url('public/page/css/util.css') !!}">
	<link rel="stylesheet" type="text/css" href="{!! url('public/page/css/main.css') !!}">
<!--===============================================================================================-->
</head>
			...
			<div class="wrap_header">
				...
				<div class="header-icons">
					...
					<div class="header-wrapicon2">
						<img src="{!! url('public/page/images/icons/icon-header-02.png') !!}" class="header-icon1 js-show-header-dropdown" alt="ICON">
							...
							<ul class="header-cart-wrapitem">
								<li class="header-cart-item">
									<div class="header-cart-item-img">
										<img src="{!! url('public/page/images/item-cart-01.jpg') !!}" alt="IMG">
									</div>
								...
								<li class="header-cart-item">
									<div class="header-cart-item-img">
										<img src="{!! url('public/page/images/item-cart-02.jpg') !!}" alt="IMG">
									</div>
								...
								<li class="header-cart-item">
									<div class="header-cart-item-img">
										<img src="{!! url('public/page/images/item-cart-03.jpg') !!}" alt="IMG">
									</div>
			...
			<div class="row">
				<div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
					...
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						<img src="{!! url('public/page/images/banner-02.jpg') !!}" alt="IMG-BENNER">
					...
					<!-- block1 -->
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						<img src="{!! url('public/page/images/banner-05.jpg') !!}" alt="IMG-BENNER">
				...
				<div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
					<!-- block1 -->
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						<img src="{!! url('public/page/images/banner-03.jpg') !!}" alt="IMG-BENNER">
					...
					<!-- block1 -->
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						<img src="{!! url('public/page/images/banner-07.jpg') !!}" alt="IMG-BENNER">
				...
				<div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
					<!-- block1 -->
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						<img src="{!! url('public/page/images/banner-04.jpg') !!}" alt="IMG-BENNER">
					...
					<div class="block2 wrap-pic-w pos-relative m-b-30">
						<img src="{!! url('public/page/images/icons/bg-01.jpg') !!}" alt="IMG">
			...
			<div class="wrap-slick2">
				<div class="slick2">
					...
					<div class="item-slick2 p-l-15 p-r-15">
						...
						<div class="block2">
							<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
								<img src="{!! url('public/page/images/item-02.jpg') !!}" alt="IMG-PRODUCT">
					...
					<div class="item-slick2 p-l-15 p-r-15">
						...
						<div class="block2">
							<div class="block2-img wrap-pic-w of-hidden pos-relative">
								<img src="{!! url('public/page/images/item-03.jpg') !!}" alt="IMG-PRODUCT">
					...
					<div class="item-slick2 p-l-15 p-r-15">
						...
						<div class="block2">
							<div class="block2-img wrap-pic-w of-hidden pos-relative">
								<img src="{!! url('public/page/images/item-05.jpg') !!}" alt="IMG-PRODUCT">
					...
					<div class="item-slick2 p-l-15 p-r-15">
						...
						<div class="block2">
							<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelsale">
								<img src="{!! url('public/page/images/item-07.jpg') !!}" alt="IMG-PRODUCT">
